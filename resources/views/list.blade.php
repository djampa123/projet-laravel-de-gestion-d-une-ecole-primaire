...
<meta charset="utf-8">
  ...
  <link href="assets/css/main.css" rel="stylesheet">
    ...
    <title>Liste des matières et leurs classes</title>
...
<div class="container-fluid">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto">
        ...
        <h1 class="sitename">GESTION DES MATIERES</h1>
      </a>
      ...
      <a class="btn-getstarted" href="code.html">COMMENCER</a>
  ...
  <main class="main">
    ...
    <div class="container mt-4">
        <h1>Liste des matières et leurs classes associées</h1>
            ...
            <body>
                @foreach($matieres as $matiere)
                    <tr>
                        ...
                        <td>
                            @foreach($matiere->classes as $classe)
                                {{ $classe->section->nom_section ?? 'N/A' }}<br>
                            @endforeach
                        </td>
                        <td class="actions">
                            <a href="{{ route('matieres.edit', $matiere->id_matiere) }}" class="btn btn-primary btn-sm">Modifier</a>
                            <form action="{{ route('matieres.destroy', $matiere->id_matiere) }}" method="POST" style="display: inline-block;">
                                @csrf
                                @method('DELETE')
